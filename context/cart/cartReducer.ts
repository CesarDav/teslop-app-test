...
type CartActionType =
    | { type: '[Cart] - LoadCart from cookkies | storage', payload: ICartProduct[] }
    ...
    | { type: '[Cart] - LoadAddress from cookkies ', payload: ShippingAddress }
...
export const cartReducer = (state: CartState, action: CartActionType): CartState => {
    ...
    switch (action.type) {
        case '[Cart] - LoadCart from cookkies | storage':
            return {
                ...state,
                isLoaded: true,
                cart: action.payload
        ...
        case '[Cart] - LoadAddress from cookkies ':
            return {
                ...state,
